...
**Not a Bank** occupies the intersection of three aesthetics:
...
2. **ZKsync technical authority** — Dark-first, monospace numerals, cryptographic precision. The aesthetic signals that something serious and advanced is happening beneath the surface.
...
--bg-surface:   #111113   (zinc-950 +) — Cards, panels  
...
--accent-hover:     #6481F8   — Hover state of primary
...
```
Display:    48px / 52px line-height / weight 600   — Balance hero
Heading 1:  32px / 40px / weight 600               — Page titles
Heading 2:  24px / 32px / weight 600               — Section headers
Heading 3:  20px / 28px / weight 500               — Card titles
Body:       16px / 24px / weight 400               — Primary content
Body SM:    14px / 20px / weight 400               — Secondary content
Label:      12px / 16px / weight 500               — UI labels
Micro:      11px / 14px / weight 500               — Badges, captions
```
...
```
Font:            JetBrains Mono, 32px, weight 500
Text-align:      right
...
Nav Item active:
  ...
  Border-left:   2px solid var(--accent-primary) (positioned outside padding)
```
...
### Policy
**Not a Bank uses no illustrations, no photography, and no decorative imagery.**

Reasoning: Illustrations infantilize financial software. Photography adds visual noise. Empty states and placeholder content use icon + typography only.
