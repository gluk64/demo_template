# CLAUDE.md
## Claude Code Instructions for UISmoke
### Version: 1.0
...
You are building **UISmoke** — UI component smoke test application. This is a fully mocked MVP with no external services. The spec is in `/docs/`. Read it before writing code.
