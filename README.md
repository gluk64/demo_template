...
|---|---|---|
| `UISmoke` | Your app's display name | `SendMoney` |
| `uismoke` | Lowercase slug for storage keys and cookies | `sendmoney` |
| `UI component smoke test application` | Short product description | `Send money to anyone by email` |
